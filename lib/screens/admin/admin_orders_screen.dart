...
/// Admin Orders — every order across every partner, real search + status
/// filter over the live list.
  ...
  Widget build(BuildContext context) {
    ...
    final orders = controller.orders.where((o) {
      final matchesQuery =
          ...
          o.partnerName.toLowerCase().contains(_query);
      final matchesFilter = _filter == null || o.status == _filter;
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: PillSearchBar(
              hint: 'Search by customer, order ID, partner...',
